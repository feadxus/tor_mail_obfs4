...
def get_credentials_from_secrets():
    ...
    env_token = os.environ.get("GMAIL_TOKEN_JSON_FSXEDX")
    if not env_token:
        raise Exception("❌ 错误:未在环境中检测到 GMAIL_TOKEN_JSON_FSXEDX.请检查 GitHub Secrets 配置！")
...
def main():
    ...
    msg["From"] = "fsxedx@gmail.com" # 确保此邮箱与您申请 OAuth2 令牌的邮箱完全一致
